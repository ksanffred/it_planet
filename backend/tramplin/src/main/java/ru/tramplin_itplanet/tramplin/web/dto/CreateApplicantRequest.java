...
@Schema(description = "Request payload for applicant profile creation")
public record CreateApplicantRequest(
        ...
        @Schema(description = "Important details about additional education", example = "Completed Deep Learning specialization on Coursera")
